...
def create_preview_mask(
    ...
    """Create a binary MSM preview mask from one image frame."""
...
def create_mask_stack(
    ...
    """Create analysis masks from an image stack and yield per-frame progress."""
    ...
    return np.stack(analysis_masks)
