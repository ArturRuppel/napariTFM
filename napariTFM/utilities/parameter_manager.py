...
class ParameterManager(QObject):
    ...
    def get_ui_parameter(self, name: str) -> Any:
        ...
        Young's modulus is shown in kPa (stored in Pa); the two regularizers
        (FTTC/forward share one, plus BISM) are shown as a base-10 exponent
        (stored as the actual value). gel_height's
